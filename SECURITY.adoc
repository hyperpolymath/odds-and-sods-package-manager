...
[arabic]
. Navigate to
https://github.com/hyperpolymath/odds-and-sods-package-manager/security/advisories/new[Report
a Vulnerability]
...
[width="100%",cols="21%,11%,68%",options="header",]
|===
...
|*Resolution* |90 days |Target for fix developsment and release (complex
...
* This repository (`+hyperpolymath/odds-and-sods-package-manager+`) and
all its code
...
https://github.com/hyperpolymath/odds-and-sods-package-manager/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/odds-and-sods-package-manager/discussions[GitHub
Discussions]
...
_Thank you for helping keep Odds And Sods Package Manager and its users
safe._ 🛡️
