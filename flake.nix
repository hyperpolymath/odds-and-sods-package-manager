{
  description = "odds-and-sods-package-manager - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 odds-and-sods-package-manager development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "odds-and-sods-package-manager";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P odds-and-sods-package-manager.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/odds-and-sods-package-manager $out/bin/  # Rust
            # cp bin/odds-and-sods-package-manager $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/odds-and-sods-package-manager";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-odds-and-sods-package-manager" {
