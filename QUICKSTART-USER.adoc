...
// Replace odds-and-sods-package-manager, Odds And Sods Package Manager — See README.adoc for details., just run, Odds And Sods Package Manager started successfully. with actuals
= odds-and-sods-package-manager — Quick Start for Users
:toc:
:toclevels: 2

== What is odds-and-sods-package-manager?

Odds And Sods Package Manager — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./odds-and-sods-package-manager-portable
----
...
[source]
----
Odds And Sods Package Manager started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/odds-and-sods-package-manager/wiki
