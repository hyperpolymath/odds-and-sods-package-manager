...
defmodule Opsm.Registries.QuandleDB do
  ...
  @known_packages [
    %{
      ...
      path: "quandledb",
      description:
        "QuandleDB core — quandle algebra, semantic identity, self-distributive operations"
    },
    %{
    ...
    %{
      ...
      description:
        "Idris2 connector for QuandleDB — dependent-typed algebraic queries with proofs"
    },
    %{
      name: "quandledb-rust",
      url: "https://github.com/hyperpolymath/nextgen-databases",
  ...
  defp curated_to_resolved(pkg_info, version) do
    %ResolvedPackage{
      ...
      manifest: %ManifestFormat{
        ...
        dev_dependencies: %{},
        source_forth: :quandledb,
        raw_manifest: %{"registry" => "quandledb-curated"}
      },
      attestations: [],
      resolved_deps: []
    }
