...
defmodule Opsm.Registries.Lithoglyph do
  ...
  defp parse_lithoglyph_toml(toml_text, pkg_info, version) do
    ...
    pkg = %ResolvedPackage{
      package: pkg_name, version: fields["version"] || version, forth: :lithoglyph,
      ...
      manifest: %ManifestFormat{
        ...
        source_forth: :lithoglyph, raw_manifest: fields
      },
  ...
  defp curated_to_resolved(pkg_info, version) do
    %ResolvedPackage{
      package: pkg_info.name, version: version, forth: :lithoglyph,
      ...
      manifest: %ManifestFormat{
        ...
        dependencies: %{}, dev_dependencies: %{},
        source_forth: :lithoglyph, raw_manifest: %{"registry" => "lithoglyph-curated"}
      },
      attestations: [], resolved_deps: []
    }
  end
  ...
  defp parse_registry_package(data, version) do
    %ResolvedPackage{
      package: data["name"], version: version, forth: :lithoglyph, registry_url: @base_url,
      ...
      manifest: %ManifestFormat{
        ...
        source_forth: :lithoglyph, raw_manifest: data
      },
