...
defmodule Opm.Package.TransactionTest do
  ...
  describe "safe_symlink/3" do
    setup do
      ...
      tmp_dir = Path.join(System.tmp_dir!(), "opm_test_#{:rand.uniform(1_000_000)}")
  ...
  describe "rollback/1" do
    setup do
      tmp_dir = Path.join(System.tmp_dir!(), "opm_rollback_#{:rand.uniform(1_000_000)}")
      File.mkdir_p!(tmp_dir)
