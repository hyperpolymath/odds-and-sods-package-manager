...
defmodule Opm.Config do
  ...
  alias Opm.Types.{HttpConfig, ServiceConfig, OpmConfig}
  ...
  defp load_from_env do
    case System.get_env("OPM_CONFIG") do
      nil -> {:error, "OPM_CONFIG not set"}
    ...
    case reason do
      :enoent ->
        ...
        Create a config file with:
          mkdir -p ~/.config/opm
          touch ~/.config/opm/opm.toml

        Or set OPM_CONFIG environment variable to your config path.
        """
