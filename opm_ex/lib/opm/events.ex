...
defmodule Opm.Events do
  ...
  alias Opm.Clients.CicdHyperA
  alias Opm.Types.OpmConfig
  ...
  ## Parameters
  - `config`: OPM configuration with cicd-hyper-a endpoint
  ...
  """
  @spec publish_event(OpmConfig.t(), event_type(), event_data()) ::
          {:ok, map()} | {:error, term()}
  def publish_event(%OpmConfig{} = config, event_type, event_data)
  ...
  """
  @spec publish_security_advisory(OpmConfig.t(), String.t(), String.t(), map()) ::
          {:ok, map()} | {:error, term()}
  ...
  """
  @spec notify_dependents(OpmConfig.t(), String.t(), [String.t()]) ::
