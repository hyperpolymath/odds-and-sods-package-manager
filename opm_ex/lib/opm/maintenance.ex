...
defmodule Opm.Maintenance do
  ...
  @history_path Path.expand("~/.local/share/opm/history.json")
  @pins_path Path.expand("~/.local/share/opm/pins.json")
  ...
  defp clean_cache(dry_run) do
    cache_dir = Path.expand("~/.cache/opm/packages")
  ...
  defp clean_tmp(dry_run) do
    tmp_dir = Path.expand("~/.cache/opm/tmp")
