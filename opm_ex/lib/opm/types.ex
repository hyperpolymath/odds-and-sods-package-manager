...
defmodule Opm.Types do
  @moduledoc """
  Core type definitions for OPM CLI.
  """
  ...
  defmodule OikosRisk do
    @type t :: %__MODULE__{
            severity: Opm.Types.risk_severity(),
            category: String.t(),
  ...
  defmodule OikosHealthResponse do
    @type t :: %__MODULE__{
            status: Opm.Types.service_status(),
            version: String.t(),
            uptime: integer()
          }
  ...
  defmodule AttestationRef do
    @type t :: %__MODULE__{
            attestation_type: Opm.Types.attestation_type(),
            uri: String.t(),
            digest: String.t()
          }
  ...
  defmodule ClaimForgeRequest do
    @type t :: %__MODULE__{
            ...
            claim_type: Opm.Types.claim_type(),
            metadata: map() | nil
          }
  ...
  defmodule Finding do
    @type t :: %__MODULE__{
            severity: Opm.Types.finding_severity(),
            category: String.t(),
  ...
  defmodule VerificationResult do
    @type t :: %__MODULE__{
            verification_type: Opm.Types.verification_type(),
            passed: boolean(),
            coverage: float() | nil,
            findings: [Finding.t()],
            duration: integer()
  ...
  defmodule CheckyMonkeyRequest do
    @type t :: %__MODULE__{
            repository_url: String.t(),
            commit_sha: String.t(),
            verification_types: [Opm.Types.verification_type()],
            timeout: integer() | nil
          }
  ...
  defmodule CheckyMonkeyResponse do
    @type t :: %__MODULE__{
            request_id: String.t(),
            status: Opm.Types.verification_status(),
  ...
  defmodule DetectedLicense do
    @type t :: %__MODULE__{
            ...
            confidence: float(),
            locations: [String.t()],
            source: Opm.Types.license_source()
          }
  ...
  defmodule LicenseConflict do
    @type t :: %__MODULE__{
            ...
            license2: String.t(),
            reason: String.t(),
            severity: Opm.Types.conflict_severity()
          }
  ...
  defmodule LicenseObligation do
    @type t :: %__MODULE__{
            license: String.t(),
            obligation: String.t(),
            obligation_type: Opm.Types.obligation_type()
          }
  ...
  defmodule LicenseRisk do
    @type t :: %__MODULE__{
            severity: Opm.Types.license_risk_severity(),
            license: String.t(),
            risk: String.t(),
  ...
  defmodule ForthConfig do
    ...
    @type t :: %__MODULE__{
            name: atom(),
            forth_type: Opm.Types.forth_type(),
            base_url: String.t(),
            federation_mode: Opm.Types.federation_mode(),
  ...
  defmodule ManifestFormat do
    ...
    @type t :: %__MODULE__{
            ...
            bin: map(),
            scripts: map(),
            source_forth: Opm.Types.forth_type() | nil,
  ...
  defmodule InstallRequest do
    ...
    @type t :: %__MODULE__{
            ...
            forth: Opm.Types.forth_type() | nil,
            channel: Opm.Types.release_channel(),
            scope: Opm.Types.install_scope(),
            dry_run: boolean(),
            force: boolean(),
  ...
  defmodule ConnectionPort do
    ...
    Allows OPM to export packages to deb/rpm/winget/etc.
    """
    @type t :: %__MODULE__{
            target: Opm.Types.forth_type(),
            command: String.t(),
