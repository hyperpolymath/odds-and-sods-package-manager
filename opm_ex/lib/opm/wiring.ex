...
defmodule Opm.Wiring do
  ...
  def run_status(%OpmConfig{} = config) do
    clients = [
  ...
  def run_publish(%OpmConfig{} = config, path) do
  ...
  def run_audit(%OpmConfig{} = config, package) do
