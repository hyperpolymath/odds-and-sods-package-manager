...
Odds And Sods Package Manager a harassment-free experience for everyone,
...
* Posting or threatening to post others’ personally identifying
information ("`doxing`")
* Advocating for, or encouraging, any of the above behaviour
* Microaggressions — subtle, often unintentional, discriminatory
comments or actions
...
* Open a
https://github.com/hyperpolymath/odds-and-sods-package-manager/discussions[Discussion]
