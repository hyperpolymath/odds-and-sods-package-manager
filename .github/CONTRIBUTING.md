...
git clone
<https://github.com/hyperpolymath/odds-and-sods-package-manager.git> cd
...
toolbox create odds-and-sods-package-manager-dev toolbox enter
odds-and-sods-package-manager-dev
...
odds-and-sods-package-manager/ ├── src/ \# Source code (Perimeter 1-2)
...
(Perimeter 3) ├── examples/ \# Examples (Perimeter 3) ├── spec/
